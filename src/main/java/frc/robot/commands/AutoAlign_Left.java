...
public class AutoAlign_Left extends Command {
    ...
    public void execute() {
        ...
        m_yspeed = NetworkTableInstance.getDefault().getTable(Constants.limelightConstants.rightLimelight).getEntry("ty").getDouble(Constants.limelightConstants.defaultValue)*alignmentSpeed;
        System.out.println("Running alignment command");
        System.out.println("limelight x" +m_xspeed);
