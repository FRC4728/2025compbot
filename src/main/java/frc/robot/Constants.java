...
public final class Constants {
    ...
    public static final class ElevatorConstants {
        ...
        public static double kAcceleration = 250; //Was 120
        public static double kCruiseVelo = 150; //Was 110
    ...
    public static final class IntakeConstants {
        ...
        public static double runIntakeInVelo = -25;
        public static double runIntakeOutVelo = 30; //30
        public static double runIntakeScoreVelo = 45;
        public static double runIntakeScoreL1Velo = 30;
        ...
        public static int photoCellDIO = 7;
            ...
            public static final class Algae{
                ...
                public static int algaeMotorID = 42;
    
                public static double inVelo = -2750; //-2500
                public static double outVelo = 4500;
                public static double idleVelo = -700; //-500
            }
        }
    ...
    public static final class WristConstants {
        ...
        public static double kAcceleration = 105.0;
        public static double kCruiseVelo = 80.0;
